...
class TimeInterval(BaseModel):
    ...
    average_sell_price: Annotated[int, Field(description="The average selling price of the item over the time interval.")]
    average_buy_price: Annotated[int, Field(description="The average buying price of the item over the time interval.")]
