...
def item_list() -> List[Dict[str, any]]:
    return [
        ...
        #{"name": "webweaver bow", "id": 27652},
        #{"name": "ursine chainmace", "id": 27657},
        #{"name": "avernic defender", "id": 22477},
        #{"name": "masori body(f)", "id": 27238},
        #{"name": "masori chaps(f)", "id": 27241},
        #{"name": "masori mask(f)", "id": 27235},
        #{"name": "zaryte crossbow", "id": 26374},
    ]